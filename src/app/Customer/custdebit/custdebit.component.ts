...
export class CustdebitComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.service.Debit(this.cid).subscribe( (result: any) => 
    {
     // console.log(result);
      this.name=JSON.parse(JSON.stringify(result['SOAP:Envelope']['SOAP:Body']['ns0:ZFM_DEBIT_MEMO_528.Response']['CREDIT_TABLE'].item));
